...
export const ActivityInstructions = {
  ...
  [Activities.Read]:
    '<h4>Focused reading</h4><ul><li>Use your right keyboard arrow key or button to highlight each word.</li><li>Tap the key rythmically while reading out loud.</li></ul>',
  [Activities.Type]:
